...
```bash
go get github.com/artushin/mcp-golang
```
...
For a complete working example, check out our [example client implementation](https://github.com/artushin/mcp-golang/tree/main/examples/client).
